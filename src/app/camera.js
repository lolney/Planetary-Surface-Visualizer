import { Matrix4, Quaternion } from "../lib/cuon-matrix-quat";
...
export default {
  ...
  updateCamera: function() {
    ...
    if (globals.camera.lockToSun) {
      m.setRotate(globals.animation.latitude, 1, 0, 0);
      ...
      var q = globals.quaternions["view"].total;
    ...
    var po = globals.camera.position.elements;
    var e = globals.camera.eye.elements;
    h.normalize();
